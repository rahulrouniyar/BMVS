...
class Mainapp_admin(QMainWindow, ui):
    ...
    def Register_Candidate(self):
        ...
        try:
            ...
            if int(result[0])==1:
                ...
                msg = "Candidate ID :" + str(candidate_id[0])
                self.label_13.setText(msg)                    
            self.cur.close()
            self.database.close()

    def Open_Party_Registration_Tab(self):
        self.lineEdit_2.setValidator(validator_text)
        self.lineEdit_3.setValidator(validator_text)
    ...
    def Register_Party(self):
        ...
        try:
            ...
            self.tableWdiget_2.clearContents()
